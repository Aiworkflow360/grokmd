...
- **Step 2 — four more minds.** Faraday, Lovelace, Turing, Ramanujan. Build green, all five pages live.

## In progress

- **Step 3 — the remaining fifteen**, in batches of five. Next: Curie, Darwin, Shannon, Montaigne, Marcus Aurelius.
- **QA sweep** over the published five, by a reader with no memory of writing them.
